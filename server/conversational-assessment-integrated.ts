...
async function generateComprehensiveDiagnosis(
  ...
  try {
    ...
    messageAr += `---\n*هذا التقييم تم إنشاؤه بواسطة طبيبك الافتراضي باستخدام الذكاء الاصطناعي الطبي المتقدم. وهو ليس بديلاً عن الاستشارة الطبية المتخصصة. يرجى استشارة مقدم الرعاية الصحية للحصول على التشخيص والعلاج المناسب.*`;
