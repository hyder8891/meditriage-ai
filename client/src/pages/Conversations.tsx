      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg">مركز موحد لجميع تفاعلات المرضى</p>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">المحادثات</h3>
            <p className="text-muted-foreground mb-6">مركز موحد لجميع تفاعلات المرضى</p>
