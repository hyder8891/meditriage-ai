...
import { UserCircle, Mail, Lock, ArrowLeft, Eye, EyeOff, Smartphone } from "lucide-react";
              ...
              <div className="mt-4 space-y-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const authUrl = `${oauthPortalUrl}?client_id=${appId}&redirect_uri=${encodeURIComponent(redirectUri)}&state=${state}&response_type=code`;
                ...
                >
                  ...
                  {language === 'ar' ? 'تسجيل الدخول بحساب مانوس' : 'Sign in with Manus'}
                </Button>
