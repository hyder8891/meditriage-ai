...
export default function B2B2CPortal() {
    ...
    <div className="container py-8" dir="rtl">
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-4xl font-bold">بوابة B2B2C</h1>
            <p className="text-muted-foreground text-lg">واجهة الأعمال للشراكات والخدمات</p>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">بوابة B2B2C</h3>
            <p className="text-muted-foreground mb-6">واجهة الأعمال للشراكات والخدمات</p>
