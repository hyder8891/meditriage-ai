    ...
    <div className="container py-8" dir="rtl">
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-4xl font-bold">مزاد الموارد الطبية</h1>
            <p className="text-muted-foreground text-lg">سوق للمعدات والخدمات الطبية</p>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">مزاد الموارد الطبية</h3>
            <p className="text-muted-foreground mb-6">سوق للمعدات والخدمات الطبية</p>
