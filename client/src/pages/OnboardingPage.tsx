    ...
    <div className="container py-8" dir="rtl">
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-4xl font-bold">التأهيل التفاعلي</h1>
            <p className="text-muted-foreground text-lg">سير عمل تأهيل المستخدم مع دروس تعليمية</p>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">التأهيل التفاعلي</h3>
            <p className="text-muted-foreground mb-6">سير عمل تأهيل المستخدم مع دروس تعليمية</p>
